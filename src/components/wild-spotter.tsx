    ...
    <div className='flex h-screen bg-stone-100'>
      ...
      <main className='flex-1 p-6 overflow-auto'>
        ...
        <div className='bg-green-200 h-96 rounded-lg mb-6 relative'>
          ...
          {/* Sample markers */}
          <div
            className='absolute top-1/4 left-1/4 text-red-500'
            ...
            <div className='space-y-4'>
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-500'>
                    Spotted by John Doe, 2 hours ago
                  </p>
                </div>
              ...
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-500'>
                    Spotted by Jane Smith, 5 hours ago
                  </p>
                </div>
          ...
          <CardContent>
            <ul className='space-y-2'>
              <li className='flex items-center text-red-600'>
                <Bell className='mr-2' /> Endangered species sighting: Black
                Rhino at coordinates 1.23, 4.56
              </li>
              <li className='flex items-center text-yellow-600'>
                <Bell className='mr-2' /> High pollution levels reported near
                Elephant habitat
              </li>
              <li className='flex items-center text-green-600'>
                <Bell className='mr-2' /> New conservation area established for
                Giraffe population
              </li>
            </ul>
          </CardContent>
        ...
        <DialogContent className='sm:max-w-[425px]'>
          ...
          <form className='space-y-4'>
            ...
            <div>
              ...
              <Textarea
                id='notes'
                placeholder='Describe the sighting, behavior, or any concerns...'
              />
            </div>
            <Button
              type='submit'
